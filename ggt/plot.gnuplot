...
plot "flikr-test.evolution.plot" using 1:2 title 'random' with lines,\
"flikr-test.evolution.plot" using 1:3 title 'vrandom' with lines, \
"flikr-test.evolution.plot" using 1:4 title 'tbf' with lines,\
"flikr-test.evolution.plot" using 1:5 title 'complete' with lines
