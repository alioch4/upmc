...
$qnanb addPolicyEntry [$n1 id] [$nb id] TokenBucket 10 [% lambda %] 75000
$qnanb addPolicyEntry [$n2 id] [$nb id] TokenBucket 10 [% lambda %] 75000
$qnanb addPolicyEntry [$n3 id] [$nb id] Null 11

# Remarque : On peut utiliser plusieurs fois le même label

$qnanb addPolicerEntry TokenBucket 10 12
...
$qnanb addPHBEntry 11 1 0
$qnanb addPHBEntry 12 2 0

# Arguments :
# Politique; Numéro de la file à gestion de tampon RIO-C

$qnanb setMREDMode RIO-C 0
$qnanb setMREDMode RIO-C 1
$qnanb setMREDMode RIO-C 2
...
$qnanb configQ 0 0 250 250 1.0
$qnanb configQ 1 0 250 250 1.0
$qnanb configQ 2 0 0 0 1.0
